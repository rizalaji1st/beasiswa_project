...
class NominasiController extends Controller
{
    ...
    public function detail_skor($id)
    {
        ...
        foreach ($pendaftaran as $n) {
            ...
            $skor_tanggungan[] = ($result_tanggungan['skor']);
            $bobot_tanggungan[] = ($bobot_tanggungan['bobot']);
            $skor_rumah[] = ($result_status_rumah['skor']);
            $bobot_rumah[] = ($bobot_status_rumah['bobot']);
            $skor_pengAyah[] = ($result_penghasilan_ayah['skor']);
            $bobot_pengAyah[] = ($bobot_penghasilan_ayah['bobot']);
            $skor_pengIbu[] = ($result_penghasilan_ibu['skor']);
            $bobot_pengIbu[] = ($bobot_penghasilan_ibu['bobot']);
            $skor_pendAyah[] = ($result_pendidikan_ayah['skor']);
            $bobot_pendAyah[] = ($bobot_pendidikan_ayah['bobot']);
            $skor_pendIbu[] = ($result_pendidikan_ibu['skor']);
            $bobot_pendIbu[] = ($bobot_pendidikan_ibu['bobot']);
            $skor_staAyah[] = ($result_status_ayah['skor']);
            $bobot_staAyah[] = ($bobot_status_ayah['bobot']);
            $skor_staIbu[] = ($result_status_ibu['skor']);
            $bobot_staIbu[] = ($bobot_status_ibu['bobot']);
            $skor_pekAyah[] = ($result_pekerjaan_ayah['skor']);
            $bobot_pekAyah[] = ($bobot_pekerjaan_ayah['bobot']);
            $skor_pekIbu[] = ($result_pekerjaan_ibu['skor']);
            $bobot_pekIbu[] = ($bobot_pekerjaan_ibu['bobot']);
        ...
        return view(
            'pages.admin.universitas.nominasi.detail_skor',
            compact(
                'pendaftaran',
                'hasil',
                'skor_tanggungan',
