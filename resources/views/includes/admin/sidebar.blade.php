...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <li class="nav-item @yield('status-akses')">
    <a class="nav-link" href="{{url('/users')}}" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true"
    ...
    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        @can('manage-users')
        <a class="collapse-item" href="{{route('admin.users.index')}}"><i class="fa fa-users" aria-hidden="true"></i>
          Manage Users</a>
        @endcan
