        ...
        <div class="modal-content">
            ...
            <form action="{{route('admin.kriteria.store')}}" method="post">
                ...
                <div class="form-group">
                    <label for="id_jenis_kriteria">Id Kriteria</label>
                    ...
                    <div class="modal-dialog">
                        ...
                        @method('put')
                            ...
                            <div class="form-group">
                                ...
                                <input id="nama_kriteria" type="text" class="form-control" placeholder="Masukkan Nama Kriteria" 
                                name="nama_kriteria" value="{{$n->nama_kriteria}}">
                            </div>
                        </div>
                        <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
    ...
    <script>
        $(document).ready(function(){
            $(document).on('click', '#edit', function(){
                ...
                $('#edit_nama_kriteria').val(nama_kriteria);
            })
        });
    </script>
@endpush
