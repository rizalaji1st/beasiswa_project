...
class PenghasilanSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        for ($row = 0; $row < count($penghasilan); $row++) {
        		DB::table('bea_penghasilan')->insert([
		                'id_penghasilan'=>$row+1,
		                'penghasilan_min'=>$penghasilan[$row][0],
		                'penghasilan_max'=>$penghasilan[$row][1],
		                'skor'=>$penghasilan[$row][2],
        ...
        //  $i = 1;
       	// foreach ($penghasilan as $peng => $nilai) {
       	// 	foreach ($nilai as $penghasilan => $value) {
       	// 		DB::table('bea_penghasilan')->insert([
		      //           'id_penghasilan'=>$i,
		      //           'penghasilan_min'=>$peng,
		      //           'penghasilan_max'=>$peng,
		      //           'skor'=>$peng,
		      //           'created_at'=>Carbon::now(),
		      //           'updated_at'=>Carbon::now()
		      //       ]);
